...
/*   Updated: 2024/07/07 01:29:00 by kyungjle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			const t_vector2d player_pos, const t_vector2d player_dir)
{
	...
	while (++x < SCREEN_WIDTH)
	{
		...
		calc_dda_param(&(frame->dda[x]), x, player_dir, frame->camera_plane);
...
static void	calc_dda_param(t_dda *dda, const int x,
					const t_vector2d player_dir, const t_vector2d camera_plane)
{
	const t_vector2d	camera = ft_vector2d_mul(camera_plane,
